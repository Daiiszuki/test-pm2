...
def run_etl():
    print(f"[{datetime.now()}] 🚀 ETL 3 Started.")
    
    # 1. SIMULATE EXTRACT
    print(f"[{datetime.now()}] 📥 Extracting 3 from source...")
    ...
    print(f"[{datetime.now()}] ⚙️  Transforming 3 (applying tax)...")
    ...
    # 3. SIMULATE LOAD
    print(f"[{datetime.now()}] 💾 Loading 3 into destination...")
    time.sleep(2)
    ...
    print(f"[{datetime.now()}] ✅ ETL 3 Completed Successfully.\n")
...
if __name__ == "__main__":
    try:
        ...
        exit(1) # Tell PM3 something went wrong